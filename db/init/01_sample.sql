...
INSERT INTO translation_memories(title, description, user_id, source_language_id, target_language_id, tm_type_id) VALUES ('The Martian - subtitles', 'subtitles of The Martian', 2, 1, 2, 3);

INSERT INTO units(translation_memory_id, source_segment, target_segment) VALUES (1, 'Place your device in a safe area to prevent it from unauthorized use', 'Postavite uređaj na sigurno područje kako bi se spriječilo neovlašteno korištenje'), (1, 'Periodically back up personal information kept on your memory card, or stored in your device memory.', 'Povremeno kopiju osobne podatke čuvaju na memorijskoj kartici, ili pohranjene u memoriji uređaja.'), (2, 'Well, I like you know that
