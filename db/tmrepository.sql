...
CREATE TABLE IF NOT EXISTS `tmrepository`.`units` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `translation_memories_id` INT NOT NULL,
  `source_segment` TEXT NULL,
  `target_segment` TEXT NULL,
  PRIMARY KEY (`id`, `translation_memories_id`),
  INDEX `fk_units_translation_memories1_idx` (`translation_memories_id` ASC),
  CONSTRAINT `fk_units_translation_memories1`
    FOREIGN KEY (`translation_memories_id`)
