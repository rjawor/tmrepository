...
<div class="translationMemories form large-9 medium-8 columns content">
    ...
    <fieldset>
		...
		<input id="upload-format" type="radio" name="upload_format" value="txt"  onclick="showTargetFile()" checked>TXT - two .txt files, one sentence per line, equal number of lines in the files<br>
        ...
        ?>
			<div class="input file" id="target-file-div"><label for="target-file">Target file</label><input type="file" name="target_file" id="target-file"></div>    </fieldset>
